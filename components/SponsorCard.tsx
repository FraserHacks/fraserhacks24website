...
const SponsorCard = ({ name, link, image, imageHeight }: SponsorData) => {
    ...
    return (
        <a href={link} target="_blank" rel="noreferrer" className='hover:shadow-[6px_6px_0_0_rgba(92,58,146,1)] hover:border-fraser-purple border-2 border-white/10 opacity-100 rounded-sm transition-all duration-150 flex flex-col justify-center place-items-center h-full p-2'>
