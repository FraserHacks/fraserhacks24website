      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div className="flex flex-col items-center justify-center w-full md:w-[50%] ">
          <p className="flex text-xl text-center md:text-left leading-6 tracking-wide text-white">
            FraserHacks is Mississauga&apos;s largest high school hackathon organized entirely by students at John Fraser Secondary School. More than 100 students from all of Peel Region will be coming together on November 29th 2024, for a full 10 hours of friendly hacking, enthusiastic learning, and delicious food.
          </p>
